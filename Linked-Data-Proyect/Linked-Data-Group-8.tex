...
\ection{Transparencia y Confianza en los Datos}
...
\begin{thebibliography}{99}
	...
	\bibitem{20} UM. (2018). Guia de transformación de datos abierto a datos abiertos enlazados. UM \url{https://herramientas.datos.gov.co/sites/default/files/2020-11/Guia%20Linked%20Open%20Data.pdf}
	\bibitem{21} lod-cloud. (2023). LOD Cloud. lod-cloud. \url{https://lod-cloud.net/}
	\bibitem{22} BCN. (2023). Linked Open Data: ¿Qué es?. BCN. \url{https://datos.bcn.cl/es/informacion/que-es}
	\bibitem{23} David Wood, Marsha Zaidman, Luke Ruth, and Michael Hausenblas. (2013). Linked Data: Structured data on the Web. MANNING. \url{https://www.manning.com/books/linked-data}
\end{thebibliography}
